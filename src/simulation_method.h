...
#define ODE_SIMULATION_MINIMUM_PRINT_INTERVAL "ode.simulation.minimum.print.interval"
#define DEFAULT_ODE_SIMULATION_MINIMUM_PRINT_INTERVAL_VALUE 20.0
...
#define MONTE_CARLO_SIMULATION_MINIMUM_PRINT_INTERVAL "monte.carlo.simulation.minimum.print.interval"
#define DEFAULT_MONTE_CARLO_SIMULATION_MINIMUM_PRINT_INTERVAL_VALUE 20.0

#define MONTE_CARLO_SIMULATION_NUMBER_STEPS "monte.carlo.simulation.number.steps"
#define DEFAULT_MONTE_CARLO_SIMULATION_NUMBER_STEPS_VALUE 10
...
#define DEFAULT_MONTE_CARLO_SIMULATION_RANDOM_SEED_VALUE 314159
