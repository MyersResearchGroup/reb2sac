...
static RET_VAL _PrintStatistics( IMPLICIT_RUNGE_KUTTA_4_SIMULATION_RECORD *rec, FILE *file);
...
static void SetEventAssignmentsNextValuesTime( EVENT *event, IMPLICIT_RUNGE_KUTTA_4_SIMULATION_RECORD *rec, double time );
