...
static char * _GetDegradationStoichiometryAmplificationMethod7ID( ABSTRACTION_METHOD *method );
static RET_VAL _ApplyDegradationStoichiometryAmplificationMethod7( ABSTRACTION_METHOD *method, IR *ir );      
...
ABSTRACTION_METHOD *DegradationStoichiometryAmplificationMethod7Constructor(  ABSTRACTION_METHOD_MANAGER *manager ) {
    ...
    START_FUNCTION("DegradationStoichiometryAmplificationMethod7Constructor");

    if( method.manager == NULL ) {
        method.manager = manager;
        method.GetID = _GetDegradationStoichiometryAmplificationMethod7ID;
        method.Apply = _ApplyDegradationStoichiometryAmplificationMethod7;
    }
    
    amplifier = _FindAmplifier( manager );
    method._internal1 = (CADDR_T)amplifier;
    
    TRACE_0( "DegradationStoichiometryAmplificationMethod7Constructor invoked" );
    
    END_FUNCTION("DegradationStoichiometryAmplificationMethod7Constructor", SUCCESS );
    return &method;
}
...
static char * _GetDegradationStoichiometryAmplificationMethod7ID( ABSTRACTION_METHOD *method ) {
    START_FUNCTION("_GetDegradationStoichiometryAmplificationMethod7ID");
    
    END_FUNCTION("_GetDegradationStoichiometryAmplificationMethod7ID", SUCCESS );
    return "degradation-stoichiometry-amplifier7";
}
...
static RET_VAL _ApplyDegradationStoichiometryAmplificationMethod7( ABSTRACTION_METHOD *method, IR *ir ) {
    ...
    START_FUNCTION("_ApplyDegradationStoichiometryAmplificationMethod7");
    ...
    END_FUNCTION("_ApplyDegradationStoichiometryAmplificationMethod7", SUCCESS );
    return ret;
}      
