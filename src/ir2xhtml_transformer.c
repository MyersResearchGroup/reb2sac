...
static RET_VAL _VisitPWToPrintInXHTML( KINETIC_LAW_VISITOR *visitor, KINETIC_LAW *kineticLaw ) {
	...
	if (first) {
	  ...
	  } else if (GetPWTypeFromKineticLaw( kineticLaw )==KINETIC_LAW_OP_GEQ) {
	    fprintf( file, REB2SAC_XHTML_MATHML_OP_GEQ_FORMAT );
	  } else if (GetPWTypeFromKineticLaw( kineticLaw )==KINETIC_LAW_OP_LEQ) {
	    fprintf( file, REB2SAC_XHTML_MATHML_OP_LEQ_FORMAT );
	  } else if (GetPWTypeFromKineticLaw( kineticLaw )==KINETIC_LAW_OP_GT) {
	    fprintf( file, REB2SAC_XHTML_MATHML_OP_GT_FORMAT );
	  } else if (GetPWTypeFromKineticLaw( kineticLaw )==KINETIC_LAW_OP_LT) {
	    fprintf( file, REB2SAC_XHTML_MATHML_OP_LT_FORMAT );
	  } else if (GetPWTypeFromKineticLaw( kineticLaw )==KINETIC_LAW_OP_EQ) {
	    fprintf( file, REB2SAC_XHTML_MATHML_OP_EQ_FORMAT );
	  } else if (GetPWTypeFromKineticLaw( kineticLaw )==KINETIC_LAW_OP_NEQ) {
	    fprintf( file, REB2SAC_XHTML_MATHML_OP_NEQ_FORMAT );
	  } else if (GetPWTypeFromKineticLaw( kineticLaw )==KINETIC_LAW_OP_IMPLIES) {
	    fprintf( file, REB2SAC_XHTML_MATHML_OP_IMPLIES_FORMAT );
	  } else if (GetPWTypeFromKineticLaw( kineticLaw )==KINETIC_LAW_OP_MIN) {
	    fprintf( file, REB2SAC_XHTML_MATHML_OP_MIN_FORMAT );
	  } else if (GetPWTypeFromKineticLaw( kineticLaw )==KINETIC_LAW_OP_MAX) {
	    fprintf( file, REB2SAC_XHTML_MATHML_OP_MAX_FORMAT );
	  } else if (GetPWTypeFromKineticLaw( kineticLaw )==KINETIC_LAW_OP_QUOTIENT) {
	    fprintf( file, REB2SAC_XHTML_MATHML_OP_QUOTIENT_FORMAT );
	  } else if (GetPWTypeFromKineticLaw( kineticLaw )==KINETIC_LAW_OP_AND) {
	    fprintf( file, REB2SAC_XHTML_MATHML_OP_AND_FORMAT );
	  } else if (GetPWTypeFromKineticLaw( kineticLaw )==KINETIC_LAW_OP_OR) {
...
static RET_VAL _VisitUnaryOpToPrintInXHTML( KINETIC_LAW_VISITOR *visitor, KINETIC_LAW *kineticLaw ) {
    ...
    case KINETIC_LAW_UNARY_OP_INT:
	    ...
	    } else if ( unaryOpType == KINETIC_LAW_UNARY_OP_RATE ) { 
	      fprintf( file, REB2SAC_XHTML_MATHML_OP_RATE_FORMAT );
...
static BOOL _NeedParenForRight( KINETIC_LAW *parent, KINETIC_LAW *child ) {
    ...
    if( IsOpKineticLaw( child ) ) {        
	    ...
	    ( childOpType == KINETIC_LAW_OP_QUOTIENT ) ||
