...
/**
* generate birth-death by just dividing the stoichiometry from the degradation
*/


static char * _GetBirthDeathGenerationMethod4ID( ABSTRACTION_METHOD *method );
static RET_VAL _ApplyBirthDeathGenerationMethod4( ABSTRACTION_METHOD *method, IR *ir );      
...
ABSTRACTION_METHOD *BirthDeathGenerationMethod4Constructor(  ABSTRACTION_METHOD_MANAGER *manager ) {
    static ABSTRACTION_METHOD method;
    
    START_FUNCTION("BirthDeathGenerationMethod4Constructor");

    if( method.manager == NULL ) {
        method.manager = manager;
        method.GetID = _GetBirthDeathGenerationMethod4ID;
        method.Apply = _ApplyBirthDeathGenerationMethod4;
    }
    
    TRACE_0( "BirthDeathGenerationMethod4Constructor invoked" );
    
    END_FUNCTION("BirthDeathGenerationMethod4Constructor", SUCCESS );
    return &method;
}
...
static char * _GetBirthDeathGenerationMethod4ID( ABSTRACTION_METHOD *method ) {
    START_FUNCTION("_GetBirthDeathGenerationMethod4ID");
    
    END_FUNCTION("_GetBirthDeathGenerationMethod4ID", SUCCESS );
    return "birth-death-generator4";
}
...
static RET_VAL _ApplyBirthDeathGenerationMethod4( ABSTRACTION_METHOD *method, IR *ir ) {
    ...
    START_FUNCTION("_ApplyBirthDeathGenerationMethod4");
    ...
    END_FUNCTION("_ApplyBirthDeathGenerationMethod4", SUCCESS );
    return ret;
}      
