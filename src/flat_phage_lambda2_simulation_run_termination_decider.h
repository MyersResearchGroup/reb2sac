 ...
 ***************************************************************************/
#if !defined(HAVE_FLAT_PHAGE_LAMBDA2_SIMULATION_RUN_TERMINATION_DECIDER)
#define HAVE_FLAT_PHAGE_LAMBDA2_SIMULATION_RUN_TERMINATION_DECIDER
...
typedef struct {
    SPECIES *species;
    int number;
} FLAT_PHAGE_LAMBDA2_SPECIES_OF_INTEREST_ELEMENT; 

typedef struct {
    FLAT_PHAGE_LAMBDA2_SPECIES_OF_INTEREST_ELEMENT **elements;
    int size;
} FLAT_PHAGE_LAMBDA2_SPECIES_OF_INTEREST_ARRAY; 

#define FLAT_PHAGE_LAMBDA2_SIMULATION_RUN_TERMINATION_DECIDER_ID "flat.phage.lambda.2"
#define FLAT_PHAGE_LAMBDA2_NAME_OF_SPECIES_OF_INTEREST_FOR_LYSOGENY "cI2"
#define FLAT_PHAGE_LAMBDA2_NAME_OF_SPECIES_OF_INTEREST_FOR_LYSIS "Cro2"

#define FLAT_PHAGE_LAMBDA2_CI_TOTAL_THRESHOLD_KEY "flat.phage.lambda.cI.threshold"
#define FLAT_PHAGE_LAMBDA2_CRO_TOTAL_THRESHOLD_KEY "flat.phage.lambda.cro.threshold"

#define DEFAULT_FLAT_PHAGE_LAMBDA2_CI_TOTAL_THRESHOLD_VALUE 328.0
#define DEFAULT_FLAT_PHAGE_LAMBDA2_CRO_TOTAL_THRESHOLD_VALUE 133.0


struct _FLAT_PHAGE_LAMBDA2_SIMULATION_RUN_TERMINATION_DECIDER;
typedef struct _FLAT_PHAGE_LAMBDA2_SIMULATION_RUN_TERMINATION_DECIDER FLAT_PHAGE_LAMBDA2_SIMULATION_RUN_TERMINATION_DECIDER;
...
struct _FLAT_PHAGE_LAMBDA2_SIMULATION_RUN_TERMINATION_DECIDER {
    ...
    FLAT_PHAGE_LAMBDA2_SPECIES_OF_INTEREST_ARRAY *lysogenySpeciesArray;
    FLAT_PHAGE_LAMBDA2_SPECIES_OF_INTEREST_ARRAY *lysisSpeciesArray;
    double cIThreshold;
    double croThreshold;
    int lysogenyNum;
    int lysisNum;     
...
CreateFlatPhageLambda2SimulationRunTerminationDecider( 
