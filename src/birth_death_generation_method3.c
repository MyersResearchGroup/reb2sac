...
static char * _GetBirthDeathGenerationMethod3ID( ABSTRACTION_METHOD *method );
static RET_VAL _ApplyBirthDeathGenerationMethod3( ABSTRACTION_METHOD *method, IR *ir );      
...
ABSTRACTION_METHOD *BirthDeathGenerationMethod3Constructor(  ABSTRACTION_METHOD_MANAGER *manager ) {
    static ABSTRACTION_METHOD method;
    
    START_FUNCTION("BirthDeathGenerationMethod3Constructor");

    if( method.manager == NULL ) {
        method.manager = manager;
        method.GetID = _GetBirthDeathGenerationMethod3ID;
        method.Apply = _ApplyBirthDeathGenerationMethod3;
    }
    
    TRACE_0( "BirthDeathGenerationMethod3Constructor invoked" );
    
    END_FUNCTION("BirthDeathGenerationMethod3Constructor", SUCCESS );
    return &method;
}
...
static char * _GetBirthDeathGenerationMethod3ID( ABSTRACTION_METHOD *method ) {
    START_FUNCTION("_GetBirthDeathGenerationMethod3ID");
    
    END_FUNCTION("_GetBirthDeathGenerationMethod3ID", SUCCESS );
    return "birth-death-generator3";
}
...
static RET_VAL _ApplyBirthDeathGenerationMethod3( ABSTRACTION_METHOD *method, IR *ir ) {
    ...
    START_FUNCTION("_ApplyBirthDeathGenerationMethod3");
    ...
    END_FUNCTION("_ApplyBirthDeathGenerationMethod3", SUCCESS );
    return ret;
}      
...
ABSTRACTION_METHOD *method, SPECIES *species, double stoichiometry ) {
    ...
    replacement = CreateOpKineticLaw( KINETIC_LAW_OP_MINUS, replacement, 
				      CreateRealValueKineticLaw( (double)( ((long)stoichiometry>>2) + 1) ) );
    return replacement;                      
