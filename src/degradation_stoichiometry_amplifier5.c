...
static char * _GetDegradationStoichiometryAmplificationMethod5ID( ABSTRACTION_METHOD *method );
static RET_VAL _ApplyDegradationStoichiometryAmplificationMethod5( ABSTRACTION_METHOD *method, IR *ir );      
...
static RET_VAL _GenerateProductionWaitingTime( ABSTRACTION_METHOD *method, SPECIES *species, REACTION *reaction, KINETIC_LAW *productionKineticLaw, KINETIC_LAW *degradationKineticLaw, double stoichiometry );
static RET_VAL _GenerateDegradationWaitingTime( ABSTRACTION_METHOD *method, SPECIES *species, REACTION *reaction, KINETIC_LAW *productionKineticLaw, KINETIC_LAW *degradationKineticLaw, double stoichiometry );


static UINT32 _FindAmplifier( ABSTRACTION_METHOD_MANAGER *manager );


ABSTRACTION_METHOD *DegradationStoichiometryAmplificationMethod5Constructor(  ABSTRACTION_METHOD_MANAGER *manager ) {
    static ABSTRACTION_METHOD method;
    UINT32 amplifier = 0;
    
    START_FUNCTION("DegradationStoichiometryAmplificationMethod5Constructor");

    if( method.manager == NULL ) {
        method.manager = manager;
        method.GetID = _GetDegradationStoichiometryAmplificationMethod5ID;
        method.Apply = _ApplyDegradationStoichiometryAmplificationMethod5;
    }
    
    amplifier = _FindAmplifier( manager );
    method._internal1 = (CADDR_T)amplifier;
    
    TRACE_0( "DegradationStoichiometryAmplificationMethod5Constructor invoked" );
    
    END_FUNCTION("DegradationStoichiometryAmplificationMethod5Constructor", SUCCESS );
    return &method;
}
...
static char * _GetDegradationStoichiometryAmplificationMethod5ID( ABSTRACTION_METHOD *method ) {
    START_FUNCTION("_GetDegradationStoichiometryAmplificationMethod5ID");
    
    END_FUNCTION("_GetDegradationStoichiometryAmplificationMethod5ID", SUCCESS );
    return "degradation-stoichiometry-amplifier5";
}
...
static RET_VAL _ApplyDegradationStoichiometryAmplificationMethod5( ABSTRACTION_METHOD *method, IR *ir ) {
    ...
    START_FUNCTION("_ApplyDegradationStoichiometryAmplificationMethod5");
    ...
    END_FUNCTION("_ApplyDegradationStoichiometryAmplificationMethod5", SUCCESS );
    return ret;
}      
...
static RET_VAL _DoTransformation( ABSTRACTION_METHOD *method, IR *ir, SPECIES *species ) {
    ...
    if( IS_FAILED( ( ret = _GenerateProductionWaitingTime( method, species, production, productionKineticLaw, degradationKineticLaw, stoichiometry ) ) ) ) {
        return ret;
    }
    if( IS_FAILED( ( ret = _GenerateDegradationWaitingTime( method, species, degradation, productionKineticLaw, degradationKineticLaw, stoichiometry ) ) ) ) {
        return ret;
    }
...
KINETIC_LAW *degradationKineticLaw, double stoichiometry ) {
    ...
    temp3 = CreateOpKineticLaw( KINETIC_LAW_OP_POW, CloneKineticLaw( temp1 ), CreateRealValueKineticLaw( n - 1.0 ) ); 
    temp2 = CreateOpKineticLaw( KINETIC_LAW_OP_DIVIDE, temp2, temp3 );
    temp1 = CreateOpKineticLaw( KINETIC_LAW_OP_MINUS, temp1, temp2 );            
    newKineticLaw = CreateOpKineticLaw( KINETIC_LAW_OP_TIMES, CreateRealValueKineticLaw( 1.0  / n ), temp1 ); 
...
static RET_VAL _AdjustDegradationKineticLaw( ABSTRACTION_METHOD *method, SPECIES *species, REACTION *reaction, KINETIC_LAW *productionKineticLaw, KINETIC_LAW *degradationKineticLaw, double stoichiometry ) {
    ...
    temp1 = CreateOpKineticLaw( KINETIC_LAW_OP_PLUS, CloneKineticLaw( productionKineticLaw ), CloneKineticLaw( degradationKineticLaw ) );    
    temp2 = CreateOpKineticLaw( KINETIC_LAW_OP_POW, CloneKineticLaw( degradationKineticLaw ), CreateRealValueKineticLaw( n ) ); 
    temp3 = CreateOpKineticLaw( KINETIC_LAW_OP_POW, temp1, CreateRealValueKineticLaw( n - 1.0 ) ); 
    temp2 = CreateOpKineticLaw( KINETIC_LAW_OP_DIVIDE, temp2, temp3 );
    newKineticLaw = CreateOpKineticLaw( KINETIC_LAW_OP_TIMES, CreateRealValueKineticLaw( 1.0  / n ), temp1 ); 
...
static RET_VAL _GenerateProductionWaitingTime( 
ABSTRACTION_METHOD *method, SPECIES *species, 
REACTION *reaction, KINETIC_LAW *productionKineticLaw, 
KINETIC_LAW *degradationKineticLaw, double stoichiometry ) {
    RET_VAL ret = SUCCESS;
    double n = (double)(stoichiometry);
    ...
    SetWaitingTimeInReactionNode( reaction, newKineticLaw );
            
    return SUCCESS;
}

static RET_VAL _GenerateDegradationWaitingTime( 
ABSTRACTION_METHOD *method, SPECIES *species, 
REACTION *reaction, KINETIC_LAW *productionKineticLaw, 
KINETIC_LAW *degradationKineticLaw, double stoichiometry ) {
    RET_VAL ret = SUCCESS;
