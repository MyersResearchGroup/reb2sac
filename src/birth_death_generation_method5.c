...
static char * _GetBirthDeathGenerationMethod5ID( ABSTRACTION_METHOD *method );
static RET_VAL _ApplyBirthDeathGenerationMethod5( ABSTRACTION_METHOD *method, IR *ir );      
...
ABSTRACTION_METHOD *BirthDeathGenerationMethod5Constructor(  ABSTRACTION_METHOD_MANAGER *manager ) {
    static ABSTRACTION_METHOD method;
    
    START_FUNCTION("BirthDeathGenerationMethod5Constructor");

    if( method.manager == NULL ) {
        method.manager = manager;
        method.GetID = _GetBirthDeathGenerationMethod5ID;
        method.Apply = _ApplyBirthDeathGenerationMethod5;
    }
    
    TRACE_0( "BirthDeathGenerationMethod5Constructor invoked" );
    
    END_FUNCTION("BirthDeathGenerationMethod5Constructor", SUCCESS );
    return &method;
}
...
static char * _GetBirthDeathGenerationMethod5ID( ABSTRACTION_METHOD *method ) {
    START_FUNCTION("_GetBirthDeathGenerationMethod5ID");
    
    END_FUNCTION("_GetBirthDeathGenerationMethod5ID", SUCCESS );
    return "birth-death-generator5";
}
...
static RET_VAL _ApplyBirthDeathGenerationMethod5( ABSTRACTION_METHOD *method, IR *ir ) {
    ...
    START_FUNCTION("_ApplyBirthDeathGenerationMethod5");
    ...
    END_FUNCTION("_ApplyBirthDeathGenerationMethod5", SUCCESS );
    return ret;
}      
