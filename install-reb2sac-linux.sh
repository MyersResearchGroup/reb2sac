...
if [ -f "Makefile" ]; then
    ...
    if test $OS = "Darwin" 
    then
	CFLAGS="-I${BIOSIM}/include -O0 -g3 -mmacosx-version-min=10.7 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.7.sdk -arch x86_64 -DNAME_FOR_ID" \
