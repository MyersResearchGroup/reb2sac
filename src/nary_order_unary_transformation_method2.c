...
ABSTRACTION_METHOD *NaryOrderUnaryTransformationMethod2Constructor(  ABSTRACTION_METHOD_MANAGER *manager ) {
    static ABSTRACTION_METHOD method;
    HASH_TABLE *table = NULL;
    NARY_ORDER_DECIDER *decider = NULL;
    static CRITICAL_CONCENTRATION_FINDER finder;
    
    START_FUNCTION("NaryOrderUnaryTransformationMethod2Constructor");
    ...
    if( method.manager == NULL ) {
        ...
        if( ( table = CreateHashTable( 64 ) ) == NULL ) {
            END_FUNCTION("NaryOrderUnaryTransformationMethod2Constructor", FAILING );
            return NULL;
        }
    ...
    TRACE_0( "NaryOrderUnaryTransformationMethod2Constructor invoked" );
    
    END_FUNCTION("NaryOrderUnaryTransformationMethod2Constructor", SUCCESS );
    return &method;
}
...
static char * _GetNaryOrderUnaryTransformationMethodID( ABSTRACTION_METHOD *method ) {
    ...
    return "nary-order-unary-transformer2";
}
