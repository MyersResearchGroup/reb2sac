...
static RET_VAL _PrintStatistics( IMPLICIT_GEAR1_SIMULATION_RECORD *rec, FILE *file);
...
DLLSCOPE RET_VAL STDCALL DoImplicitGear1Simulation( BACK_END_PROCESSOR *backend, IR *ir ) {
	...
	return ErrorReport( ret, "DoImplicitGear1Simulation", "Cycle detected in initial and rule assignments" );
      }
